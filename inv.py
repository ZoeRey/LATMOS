...
dates=["20180212","20180212","20180212","20180212","20180212"]
hour=["010000","011003","012005","013007","014010"]
...
#%% recherche zone aveugelement, zoom sur les 100 premiers mètres
g=[]
for i in range(len(altitude)):
    g.append(0.045)
...
plt.figure()
plt.title(dates[2]+' '+hour[0]+', 532 nm')
plt.plot(data532moy,altitude,linewidth=1.)
plt.plot(g, linestyle='--')
...
plt.xlim(0,20)
plt.ylabel("altitude (km)")
plt.xlabel("PR2, voie 1")
#plt.grid()
plt.legend()
plt.show()


#%%lecture fonction de recouvrement
...
plt.plot(geom808_fit,altitude,label="808nm")
...
#%%Recherche de la fonction de recouvrement
"""
approx=[]
x=altitude[8:10]
y=data532cor[8:10]
...
plt.figure()
plt.title(dates[0]+" "+hour[0]+' Vérification superpostition courbes, 808')
...
plt.figure()
plt.title(dates[0]+" "+hour[0]+' Vérification superpostition courbes, 532')
...
plt.subplot(121)
plt.title('PR2')
plt.plot(data808moy1[:100],altitude1[:100],linewidth=1.,label="PR2")
#plt.ylim(0,1)
plt.xscale('log')
plt.ylabel("altitude (km)")
...
plt.plot(data808cor[:100],altitude[:100],linewidth=1.)
...
plt.figure()
plt.title(dates[2]+" "+hour[2]+", 532nm")
plt.subplot(1,2,1)

plt.subplot(121)
plt.title('PR2')
plt.plot(data532moy1[:100],altitude1[:100],linewidth=1.,label="PR2")
#plt.ylim(0,1)
plt.xscale('log')
plt.ylabel("altitude (km)")
plt.xlabel("voie 532// (UA)")


plt.subplot(122)
plt.title('PR2 corrigé')
plt.plot(data532cor[:100],altitude[:100],linewidth=1.)
plt.xlabel("voie 532// (km⁻¹ sr⁻¹)")
#plt.grid()
#plt.ylim(0,1)
plt.xscale('log')
plt.legend()
...
beta808_aer=outils.calc_beta_aer_stable2(izr,data808moy_zr,altitude,rayleigh808,data808moy,LRp,LRm,cste808)
beta532_aer=outils.calc_beta_aer_stable2(izr,data532moy_zr,altitude,rayleigh532,data532moy,LRp,LRm,cste532)

#beta808_aer_dp=outils.calc_beta_aer_stable2(izr,data808moy_dp_zr,altitude,rayleigh808,data808moy,LRp,LRm,cste808_dp)
#beta532_aer_dp=outils.calc_beta_aer_stable2(izr,data532moy_dp_zr,altitude,rayleigh532,data532moy,LRp,LRm,cste532_dp)
...
plt.figure()
plt.title("Profil de rétrodiffusion 808 "+dates[2]+' '+hour[2])
...
plt.figure()
plt.title("Profil de rétrodiffusion 532 "+dates[2]+' '+hour[2])
